...
WAGO_PARAMS = [
    ...
    ("Speed_Out_Drive", "Relay Booster Pump Speed Ref to Drive", "AO", 0, 1, "Raw", "0-20mA", "750-552"),
    ...
    ("RB_Local_Control", "Relay Booster Local Control", "DI", 3, 1, "Bool", "0-1", "750-421"),
    ("RB_Remote_Control", "Relay Booster Remote Control", "DI", 4, 1, "Bool", "0-1", "750-421"),
    ("RB_Breaker_Close", "Relay Booster Breaker Close", "DI", 7, 1, "Bool", "0-1", "750-421"),
    ("RB_Breaker_Open", "Relay Booster Breaker Open", "DI", 8, 1, "Bool", "0-1", "750-421"),
    ("RB_Estop_Status", "Relay Booster E-Stop Status", "DI", 11, 1, "Bool", "0-1", "750-421"),
    ...
    ("Spare_DI_31", "Converter Cooling Water Pump 2 Running", "DI", 31, 1, "Bool", "0-1", "750-421"),
    ("Conv_Pump_Hand", "Converter Cooling Water Pump No.1 Hand", "DI", 32, 1, "Bool", "0-1", "750-421"),
    ("Conv_Pump_Auto", "Converter Cooling Water Pump Auto", "DI", 35, 1, "Bool", "0-1", "750-421"),
    ("Conv_Pump_Run", "Converter Cooling Water Pump 1 Running", "DI", 36, 1, "Bool", "0-1", "750-421"),
    ("Drive_Coolant_Flow", "Drive Coolant Flow", "DI", 39, 1, "Bool", "0-1", "750-421"),
    ("Drive_Coolant_Press", "Drive Coolant Pressure", "DI", 40, 1, "Bool", "0-1", "750-421"),
    ("Drive_Coolant_Leak", "Drive Coolant Leakage", "DI", 43, 1, "Bool", "0-1", "750-421"),
    ("Spare_DI_44", "Spare", "DI", 44, 1, "Bool", "0-1", "750-421"),
    ("Spare_DI_47", "Spare", "DI", 47, 1, "Bool", "0-1", "750-421"),
    ("Spare_DI_48", "Relay booster pump start", "DI", 48, 1, "Bool", "0-1", "750-421"),
    ("Spare_DI_51", "Spare", "DI", 51, 1, "Bool", "0-1", "750-421"),
    ("RB_Blower_Run_Status", "Relay Booster Pump Blower Motor Run Status", "DI", 52, 1, "Bool", "0-1", "750-421"),
    ("RB_Blower_Press_Sw", "Relay Booster Pump Motor Blower Pressure Switch", "DI", 55, 1, "Bool", "0-1", "750-421"),
    ("Spare_DI_56", "Spare", "DI", 56, 1, "Bool", "0-1", "750-421"),
    ("RB_Drive_OK", "Relay Booster Pump Drive DO1 Drive OK", "DI", 59, 1, "Bool", "0-1", "750-421"),
    ("RB_Drive_Running", "Relay Booster Pump Drive DO2 Drive Running", "DI", 60, 1, "Bool", "0-1", "750-421"),
    ("RB_Precharge_OK", "Relay Booster Pump Drive DO3 Precharge Complete", "DI", 63, 1, "Bool", "0-1", "750-421"),
    ...
    ("Conv_Cooling_Start", "Converter Cooling Water Pump 1 Start", "DO", 0, 1, "Bool", "0-1", "750-600"),
    ...
    ("RB_Main_Brk_Open", "Relay Booster Main Breaker Open", "DO", 5, 1, "Bool", "0-1", "750-600"),
    ("Spare_DO_06", "Spare", "DO", 6, 1, "Bool", "0-1", "750-600"),
    ("RB_Estop_Reset", "Relay Pump E-Stop Reset", "DO", 7, 1, "Bool", "0-1", "750-600"),
    ("RB_Blower_Start", "Relay Booster Pump Motor Blower Start", "DO", 8, 1, "Bool", "0-1", "750-600"),
    ...
    ("Drive_Cooling_Start", "Drive Cooling Water Pump 2 Start", "DO", 17, 1, "Bool", "0-1", "750-600"),
    ...
    ("RB_Drive_Start", "Relay Booster Pump Drive Start", "DO", 20, 1, "Bool", "0-1", "750-600"),
    ("RB_Drive_Reset", "Relay Booster Pump Drive Reset", "DO", 21, 1, "Bool", "0-1", "750-600"),
    ("Spare_DO_22", "Relay Booster Pump Drive (Spare)", "DO", 22, 1, "Bool", "0-1", "750-600"),
